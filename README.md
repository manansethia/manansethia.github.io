...
Welcome to the open-source repository for my personal portfolio website, **[manansethia.com](https://manansethia.com)**. This site serves as my digital resume, showcasing my achievements, experiences, projects, and blogs, all engineered with a strict focus on performance, accessibility, and high-fidelity Apple-like aesthetics.
...
- **Hosting & Edge Delivery:** Deployed globally using **GitHub Pages** and heavily accelerated by the **Cloudflare Edge Network** (utilizing Early Hints, HTTP/3, and strict CSP policies).

---

## 📄 License & Attribution

The source code for this site is publicly available. While you are welcome to explore and learn from the codebase, the proprietary content, articles, resumes, and brand identity belong exclusively to me. 

If you'd like to use the structural boilerplate for your own portfolio, please credit the original *[Minimal Mistakes](https://mmistakes.github.io/minimal-mistakes/)* theme by Michael Rose, and the *Academic Pages* template.
